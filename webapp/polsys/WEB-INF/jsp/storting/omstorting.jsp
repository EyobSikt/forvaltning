...
<c:import url="/WEB-INF/jspf/topp.jsp">
    <c:param name="navigation" value="/polsys/storting/" />
...
<ul>
    <li><a href="<p:url value="/person/sok/" />">Finn norskepolitiker  </a></li>
<li><a href="<p:url value="/person/norskepolitikere/" />">Finn norskepolitiker 1814-d.d. (ved søk og indekser) </a></li>
...
<c:if test="${en}">
    ...
    <ul>
    <li><a href="<p:url value="/person/sok/" />">Find norwegian politician  </a></li>
