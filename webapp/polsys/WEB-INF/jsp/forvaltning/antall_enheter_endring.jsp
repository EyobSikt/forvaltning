...
<h1>Organizational changes influencing the number of units (forvaltningsorgan). 1947-2012</h1>
...
<c:import url="/WEB-INF/jspf/forvaltning/antall_enheter_endring_tabell.jsp">
    <c:param name="tabelloverskrift" value="Tabell 1a. Sentraladministrative organ (direktorat m.m.)" />
</c:import>

<c:set var="tabelldata" value="${data1b}" scope="request" />
<c:import url="/WEB-INF/jspf/forvaltning/antall_enheter_endring_tabell.jsp">
    <c:param name="tabelloverskrift" value="Tabell 1b. Andre ordinære forvaltningsorgan" />
</c:import>

<c:set var="tabelldata" value="${data1c}" scope="request" />
<c:import url="/WEB-INF/jspf/forvaltning/antall_enheter_endring_tabell.jsp">
    <c:param name="tabelloverskrift" value="Tabell 1c. Forvaltningsorgan med særskilde fullmakter" />
</c:import>

<br /><br />
<h2>Grunnenhet</h2>
<c:set var="tabelldata" value="${data2a}" scope="request" />
<c:import url="/WEB-INF/jspf/forvaltning/antall_enheter_endring_tabell.jsp">
    <c:param name="tabelloverskrift" value="Tabell 2a. Nasjonal organisasjon" />
</c:import>

<c:set var="tabelldata" value="${data2b}" scope="request" />
<c:import url="/WEB-INF/jspf/forvaltning/antall_enheter_endring_tabell.jsp">
    <c:param name="tabelloverskrift" value="Tabell 2b. Sentralorgan i etat" />
</c:import>

<c:set var="tabelldata" value="${data2c}" scope="request" />
<c:import url="/WEB-INF/jspf/forvaltning/antall_enheter_endring_tabell.jsp">
    <c:param name="tabelloverskrift" value="Tabell 2c. Gruppe under departement" />
</c:import>
