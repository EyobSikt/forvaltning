...
<form action="<p:url value="/data/lokaliseringsliste" />" method="get">
...
<li><input type="checkbox" name="e" value="${endring.kode}" id="e${endring.kode}" checked="checked">
...
${en ? "From:" : "Fra:"} <input type="text" value="1947" maxlength="4" size="6" name="fy" />

<select size="1" name="fm">
<c:forEach begin="1" end="12" step="1" var="i">
<option value="${i}">${i}</option>
</c:forEach>
</select>

<select size="1" name="fd">
<c:forEach begin="1" end="31" step="1" var="i">
<option value="${i}">${i}</option>
</c:forEach>
</select>

${en ? "To:" : "Til:"} <input type="text" value="${sistOppdatertDato.aar}" maxlength="4" size="6" name="ty" />
...
<tr><td>Enheter som inngår i gruppe under etat</td><td>De enkelte fylkesarbeidskontor</td></tr>
</tbody>
</table>
