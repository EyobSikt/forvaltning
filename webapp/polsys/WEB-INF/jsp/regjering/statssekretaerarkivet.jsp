...
<c:if test="${no}"><a href="<m:url value="/en/regjering/statssekretaerarkivet/" />">View this page in English.</a></c:if>
<c:if test="${en}"><a href="<m:url value="/regjering/statssekretaerarkivet/" />">View this page in Norwegian.</a></c:if>
