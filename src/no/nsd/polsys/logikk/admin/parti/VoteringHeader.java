package no.nsd.polsys.logikk.admin.parti;
...
public class VoteringHeader {
    ...
    ArrayList<no.nsd.polsys.modell.admin.votering.stortingsperiode> orderDetailList;
    ...
    public ArrayList<no.nsd.polsys.modell.admin.votering.stortingsperiode> getVoteringParametreDetailList() {
    ...
    public void setOrderDetailList(ArrayList<no.nsd.polsys.modell.admin.votering.stortingsperiode> orderDetailList) {
