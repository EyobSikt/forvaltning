 ...
 */
public class StatsraaderDepartmentvisLogikk {
// ============================================================== Variabler
    ...
    public StatsraaderDepartmentvisLogikk() {
    }
...
***************************************************************************************************/
    private RegjeringsDepartment[] getDagensDepartment(String condition, List values) throws Exception {
        ...
        // SQL-sporring.
        String sqlSelect = "SELECT  id, kode, navn_nb AS eintaltekst, navn_en AS EngEintaltekst, DAY(fra_tidspunkt) AS startday, MONTH(fra_tidspunkt) AS startmonth , YEAR(fra_tidspunkt) AS startyear , DAY(til_tidspunkt) AS sluttday, MONTH(til_tidspunkt) AS sluttmonth, YEAR(til_tidspunkt) AS sluttyear, sortering\n" +
    ...
    for (int i = 0; i < rader.length; i++) {
        ...
        if (this.engelsk) {
            ...
            regjeringsdepartment[i].setEintaltekst_no((String) rader[i].get("eintaltekst"));
               ...
               //regjeringsdepartment[i].setDep_kode((Integer)rader[i].get("id"));
