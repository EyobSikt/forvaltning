 ...
 * @author hvb
 */
public class HierarkiEnhetregisteretTag extends SimpleTagSupport {
    ...
    private void skrivEnhet(Enhet enhet, JspWriter out, String urlPrefix, Integer idnum) throws IOException {
        ...
        if (enhet.getTilknytningsform() != null) {
            if (idnum == null) {out.print("<li class=\"hidearea\"" + (idstring.length() != 0 ? "id=\"" + idstring + "area\"" : "") + ">");}
            else {out.print("<li class=\"showarea\"" + (idstring.length() != 0 ? "id=\"" + idstring + "area\"" : "") + ">");}
        ...
        if (this.idnum != null && this.idnum.equals(enhet.getIdnum())) {
            out.print("<strong>");
        }
        out.print("<a class=\"" + this.getCssClassName(enhet) +  "\" href=\"" + urlPrefix + "/data/organisasjon/" + enhet.getIdnum() + "?aar=" + enhet.getAar() +  "\">" + this.escapeXml(enhet.getLangtNavn()) + "</a>");
        if (this.idnum != null && this.idnum.equals(enhet.getIdnum())) {
            out.print("</strong>");
        }
            ...
            if (t != null) {
                ...
                while (i.hasNext()) {
                    ...
                    if (neste.isTallgruppe()) {
                        String url = urlPrefix + "/data/organisasjon/" + enhet.getIdnum() + "/desentralisert" + (neste.getLpnr() != null ? "#" + neste.getLpnr() : "");
                        ...
                        String url = urlPrefix + "/data/organisasjon/" + enhet.getIdnum() + "/avdeling";
