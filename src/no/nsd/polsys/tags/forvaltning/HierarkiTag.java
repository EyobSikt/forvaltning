 ...
 * @author hvb
 */
public class HierarkiTag extends SimpleTagSupport {
    ...
    public void doTag() throws IOException {
        ...
        out.print("<div id=\"hierarki\">");

        out.print("<ul>");
        this.skrivEnhet(this.rot, out, urlPrefix);
        out.print("</ul>");
    ...
    private void skrivEnhet(Enhet enhet, JspWriter out, String urlPrefix) throws IOException {
        ...
        out.print("<a class=\"" + this.getCssClassName(enhet) +  "\" href=\"" + urlPrefix + "/data/enhet/" + enhet.getIdnum() + "\">" + this.escapeXml(enhet.getLangtNavn()) + "</a>");
        if (this.idnum != null && this.idnum.equals(enhet.getIdnum())) {
            out.print("</strong>");
        }
        ...
        if ((s != null && s.size() > 0) || (t != null && t.size() > 0)) {
            ...
            if (t != null) {
                ...
                while (i.hasNext()) {
                    ...
                    if (neste.isTallgruppe()) {
                        String url = urlPrefix + "/data/enhet/" + enhet.getIdnum() + "/desentralisert" + (neste.getLpnr() != null ? "#" + neste.getLpnr() : "");
                        ...
                        String url = urlPrefix + "/data/enhet/" + enhet.getIdnum() + "/avdeling";
            ...
            if (s != null) {
                ...
                while (i.hasNext()) {
                    ...
                    this.skrivEnhet(next, out, urlPrefix);
                }
            }
            out.print("</ul>");
        }
