 ...
 * @author hvb
 */
public class DepartementerAnsatteAction {
   ...
   public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
         ...
         dep = logikk.getAnsatteForDep(valgtAar, lonnskategori);
      ...
      RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/jsp/forvaltning/ansatte/depoversikt.jsp");
