...
public class RegistreStatssekretarAction {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            conn.setAutoCommit(false);
                ...
                logikk.registrerNyStatssekretar(fornavn, etternavn, foedt_dato, foedtaar, doedt_dato, doedaar, partikode, kjoenn, periodestart);
            conn.commit();
        ...
        String url = request.getContextPath() + "/regjering/statssekretar.p?lagret";
