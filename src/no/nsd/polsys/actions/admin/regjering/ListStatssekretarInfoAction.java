...
public class ListStatssekretarInfoAction extends HttpServlet {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/jsp/regjering/oppdaterestatssekretarinfo.jsp");
