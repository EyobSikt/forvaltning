...
public class LagreStatsradDoedtAction extends HttpServlet {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            logikk.LagreStatsradDoedtdato(personid, doedt_dato, doedtaar);
            conn.commit();
        ...
        String url = request.getContextPath() + "/regjering/statsrad.p?doedtdato_lagret";
