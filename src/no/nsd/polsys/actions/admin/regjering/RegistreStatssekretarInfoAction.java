...
public class RegistreStatssekretarInfoAction {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            conn.setAutoCommit(false);
                ...
                logikk.RegisterUpdateStatssekretarInfo(id, fornavn, etternavn, foedtaar, parti, kode_dep, departmentkode, embete, eksternkommentar, start_dato, slutt_dato);
            conn.commit();
        ...
        String url = request.getContextPath() + "/regjering/statssekretarinfo.p?person_id=" + id +"&lagret";
