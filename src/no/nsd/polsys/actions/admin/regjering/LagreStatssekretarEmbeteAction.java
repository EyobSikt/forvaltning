...
public class LagreStatssekretarEmbeteAction extends HttpServlet {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
             ...
             )
		{
           ...
           String url = request.getContextPath() + "/regjering/statssekretarinfo.p?person_id="+personid+"&kode_dep="+kode_dep+ "&startdato="+dato_start + "&sluttdato="+dato_slutt+"&embete_lagret";
