...
public class LagreStatssekretarStartdatoAction extends HttpServlet {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
             ...
             )
		{
            ...
            String dato = request.getParameter("virkeperiode_start");
            ...
            try {
			  ...
			  logikk.LagreStatssekretarStartdato(personid, kode_dep, startdato, sluttdato);
           ...
           String url = request.getContextPath() + "/regjering/statssekretarinfo.p?person_id="+personid+"&kode_dep="+kode_dep+"&sluttdato="+dato_slutt;
