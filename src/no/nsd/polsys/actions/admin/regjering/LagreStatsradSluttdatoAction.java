...
public class LagreStatsradSluttdatoAction extends HttpServlet {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
             ...
             )
		{
            ...
            try {
			  ...
			  logikk.LagreStatsradSluttdato(personid, kode_dep, sluttdato, startdato);
           ...
           String url = request.getContextPath() + "/regjering/statsradinfo.p?person_id="+personid+"&kode_dep="+kode_dep+"&startdato="+dato_start;
