...
public class LagreStatssekretarEksternkommentarAction extends HttpServlet {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
             ...
             )
		{
            ...
            eksternkommentar = request.getParameter("eksternkommentar");
            ...
            try {
			  ...
			  logikk.LagreStatsradEksternkommentar(personid, kode_dep, startdato, sluttdato, eksternkommentar);
           ...
           String url = request.getContextPath() + "/regjering/statssekretarinfo.p?person_id="+personid+"&kode_dep="+kode_dep+ "&startdato="+dato_start + "&sluttdato="+dato_slutt+"&eksternkommentar_lagret";
