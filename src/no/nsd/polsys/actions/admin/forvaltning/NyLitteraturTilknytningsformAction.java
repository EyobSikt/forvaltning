 ...
 * @author hvb
 */
public class NyLitteraturTilknytningsformAction {
   ...
   public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
         ...
         logikk.setConn(conn);
         logikk.registrerNyLitteraturTilknytningsform(nyLitt, tilknytningsform);
      } catch (Exception e) {
         try {
            conn.rollback();
      ...
      if (feil) {
         ...
         String url = request.getContextPath() + "/forvaltning/litteratur.p?pub_id=" + nyLitt.getPubId();
