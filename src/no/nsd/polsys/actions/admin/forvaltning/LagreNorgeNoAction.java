 ...
 * @author hvb
 */
public class LagreNorgeNoAction {
   ...
   public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
         ...
         norgenoId = Util.strengTilInteger(request.getParameter("norgeno_id"));
      } catch (Exception e) {
      ...
      try {
         ...
         logikk.setConn(conn);
         logikk.slettNorgeNoIdTilEnhet(idnum);
         if (norgenoId != null) {
            logikk.registrerNorgeNoIdTilEnhet(idnum, norgenoId);
         }
      } catch (Exception e) {
         try {
            conn.rollback();
