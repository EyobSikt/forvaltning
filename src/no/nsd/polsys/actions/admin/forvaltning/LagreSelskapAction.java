 ...
 * @author hvb
 */
public class LagreSelskapAction {
   ...
   public void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try {
         ...
         selskapsdbId = Util.strengTilInteger(request.getParameter("selskapsdb_id"));
      } catch (Exception e) {
      ...
      try {
         ...
         logikk.setConn(conn);
         logikk.oppdaterSelskapsidTilEnhet(idnum, selskapsdbId);
      } catch (Exception e) {
         try {
            conn.rollback();
